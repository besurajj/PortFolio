...
const Home = () => {
  const text =
    "Hey there! 👋 I'm Suraj, a passionate MERN Stack Developer with a love for building dynamic, scalable, and user-friendly web applications. With expertise in MongoDB, Express.js, Angular, Node.js, and a deep enthusiasm for React, I enjoy crafting seamless digital experiences that merge functionality with aesthetics.";
  ...
  return (
    <section className="relative min-h-screen flex flex-col-reverse md:flex-row items-center px-6 justify-center bg-gradient-to-b from-black to-zinc-900 text-white overflow-hidden box-border p-8">
      ...
      <div className="flex flex-col items-center md:items-start justify-center text-center md:text-left p-4 box-border md:p-0 h-auto lg:mx-8 mb-10 ">
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="mt-4 text-gray-300 sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-start font-[font3] font-bold p-3 lg:p-0"
        >
      ...
      <div className="flex items-center justify-center h-full w-full lg:mt-0 mt-15 ">
       ...
       {/* Buttons */}
       <div className="flex flex-col sm:flex-row justify-start items-start md:justify-start mt-2 absolute bottom-0 lg:mb-5 lg:w-full w-[20vh] mb-5">
          {/* <a href="#projects"> */}
